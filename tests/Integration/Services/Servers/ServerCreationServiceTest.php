...
namespace SparkPanel\Tests\Integration\Services\Servers;
...
use SparkPanel\Models\Objects\DeploymentObject;
...
class ServerCreationServiceTest extends IntegrationTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->bungeecord = Egg::query()
            ->where('author', 'support@SparkPanel.io')
    ...
    public function testServerIsCreatedWithDeploymentObject()
    {
        ...
        /** @var \SparkPanel\Models\Allocation[]|\Illuminate\Database\Eloquent\Collection $allocations */
