...
use SparkPanel\Services\Subusers\SubuserCreationService;
use SparkPanel\Repositories\Wings\DaemonServerRepository;
use SparkPanel\Transformers\Api\Client\SubuserTransformer;
...
use SparkPanel\Http\Requests\Api\Client\Servers\Subusers\GetSubuserRequest;
use SparkPanel\Http\Requests\Api\Client\Servers\Subusers\StoreSubuserRequest;
use SparkPanel\Http\Requests\Api\Client\Servers\Subusers\DeleteSubuserRequest;
use SparkPanel\Http\Requests\Api\Client\Servers\Subusers\UpdateSubuserRequest;
...
class SubuserController extends ClientApiController
{
     ...
     * @throws \SparkPanel\Exceptions\Service\Subuser\ServerSubuserExistsException
     * @throws \SparkPanel\Exceptions\Service\Subuser\UserIsServerOwnerException
     * @throws \Throwable
     */
    ...
    {
        /** @var \SparkPanel\Models\Subuser $subuser */
        $subuser = $request->attributes->get('subuser');
