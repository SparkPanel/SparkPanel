...
class FindAssignableAllocationService
{
    ...
    {
        if (!config('SparkPanel.client_features.allocations.enabled')) {
    ...
    {
        $start = config('SparkPanel.client_features.allocations.range_start', null);
        $end = config('SparkPanel.client_features.allocations.range_end', null);
