# Local Development
SparkPanel is now powered by React, Typescript, and Tailwindcss using webpack at its core to generate compiled assets.
Release versions of SparkPanel will include pre-compiled, minified, and hashed assets ready-to-go.
...
The command above will download all of the dependencies necessary to get SparkPanel assets building. After that, its as
...
the asset URLs used in SparkPanel.

#### Development Environment
If you're using the [`SparkPanel/development`](https://github.com/SparkPanel/development) environments, which are
