...
use SparkPanel\Exceptions\Http\HttpForbiddenException;
use SparkPanel\Transformers\Api\Client\TaskTransformer;
use SparkPanel\Http\Requests\Api\Client\ClientApiRequest;
use SparkPanel\Http\Controllers\Api\Client\ClientApiController;
use SparkPanel\Exceptions\Service\ServiceLimitExceededException;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use SparkPanel\Http\Requests\Api\Client\Servers\Schedules\StoreTaskRequest;
...
class ScheduleTaskController extends ClientApiController
{
    ...
    {
        $limit = config('SparkPanel.client_features.schedules.per_schedule_task_limit', 10);
