...
class DatabaseSettingsCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        $this->variables['DB_USERNAME'] = $this->option('username') ?? $this->ask(
            'Database Username',
            config('database.connections.mysql.username', 'SparkPanel')
        );
        ...
        try {
            ...
            if ($this->confirm('Go back and try again?')) {
                $this->database->disconnect('_SparkPanel_command_test');
    ...
    {
        config()->set('database.connections._SparkPanel_command_test', [
            'driver' => 'mysql',
        ...
        $this->database->connection('_SparkPanel_command_test')->getPdo();
    }
}
