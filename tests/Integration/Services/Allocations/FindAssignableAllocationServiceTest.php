...
namespace SparkPanel\Tests\Integration\Services\Allocations;
...
use SparkPanel\Exceptions\Service\Allocation\AutoAllocationNotEnabledException;
use SparkPanel\Exceptions\Service\Allocation\NoAutoAllocationSpaceAvailableException;
...
class FindAssignableAllocationServiceTest extends IntegrationTestCase
{
    ...
    public function setUp(): void
    {
        ...
        config()->set('SparkPanel.client_features.allocations.enabled', true);
        config()->set('SparkPanel.client_features.allocations.range_start', 0);
        config()->set('SparkPanel.client_features.allocations.range_end', 0);
    }
    ...
    {
        $server = $this->createServerModel();
        config()->set('SparkPanel.client_features.allocations.range_start', 5000);
        config()->set('SparkPanel.client_features.allocations.range_end', 5005);
    ...
    public function testOnlyPortNotInUseIsCreated()
    {
        ...
        config()->set('SparkPanel.client_features.allocations.range_start', 5000);
        config()->set('SparkPanel.client_features.allocations.range_end', 5001);
    ...
    {
        $server = $this->createServerModel();
        config()->set('SparkPanel.client_features.allocations.range_start', 'hodor');
        config()->set('SparkPanel.client_features.allocations.range_end', 10);
        ...
        config()->set('SparkPanel.client_features.allocations.range_start', 10);
        config()->set('SparkPanel.client_features.allocations.range_end', 'hodor');
    ...
    {
        config()->set('SparkPanel.client_features.allocations.enabled', false);
        $server = $this->createServerModel();
