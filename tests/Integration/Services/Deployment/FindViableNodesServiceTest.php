...
namespace SparkPanel\Tests\Integration\Services\Deployment;
...
use SparkPanel\Exceptions\Service\Deployment\NoViableNodeException;
...
class FindViableNodesServiceTest extends IntegrationTestCase
{
     ...
     *
     * @see https://github.com/SparkPanel/panel/issues/2529
     */
    ...
    {
        /** @var \SparkPanel\Models\Location[] $locations */
        $locations = Location::factory()->times(2)->create();

        /** @var \SparkPanel\Models\Node[] $nodes */
        $nodes = [
