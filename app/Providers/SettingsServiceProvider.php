...
class SettingsServiceProvider extends ServiceProvider
{
    ...
    protected array $keys = [
        ...
        'SparkPanel:guzzle:timeout',
        'SparkPanel:guzzle:connect_timeout',
        'SparkPanel:console:count',
        'SparkPanel:console:frequency',
        'SparkPanel:auth:2fa_required',
        'SparkPanel:client_features:allocations:enabled',
