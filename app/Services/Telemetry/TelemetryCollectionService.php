...
namespace SparkPanel\Services\Telemetry;
...
class TelemetryCollectionService
{
    ...
    /**
     * Collects telemetry data and sends it to the SparkPanel Telemetry Service.
     */
    public function __invoke(): void
    {
        ...
        Http::post('https://telemetry.SparkPanel.io', $data);
    }
