...
namespace SparkPanel\Console;

use Ramsey\Uuid\Uuid;
use SparkPanel\Models\ActivityLog;
...
use SparkPanel\Console\Commands\Schedule\ProcessRunnableCommand;
use SparkPanel\Console\Commands\Maintenance\PruneOrphanedBackupsCommand;
use SparkPanel\Console\Commands\Maintenance\CleanServiceBackupFilesCommand;
...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule): void
    {
        ...
        if (config('SparkPanel.telemetry.enabled')) {
