...
use SparkPanel\Helpers\Utilities;
use SparkPanel\Exceptions\DisplayException;
use SparkPanel\Repositories\Eloquent\ScheduleRepository;
use SparkPanel\Services\Schedules\ProcessScheduleService;
use SparkPanel\Transformers\Api\Client\ScheduleTransformer;
use SparkPanel\Http\Controllers\Api\Client\ClientApiController;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use SparkPanel\Http\Requests\Api\Client\Servers\Schedules\ViewScheduleRequest;
use SparkPanel\Http\Requests\Api\Client\Servers\Schedules\StoreScheduleRequest;
use SparkPanel\Http\Requests\Api\Client\Servers\Schedules\DeleteScheduleRequest;
use SparkPanel\Http\Requests\Api\Client\Servers\Schedules\UpdateScheduleRequest;
use SparkPanel\Http\Requests\Api\Client\Servers\Schedules\TriggerScheduleRequest;
...
class ScheduleController extends ClientApiController
{
    ...
    public function update(UpdateScheduleRequest $request, Server $server, Schedule $schedule): array
    {
        ...
        //
        // @see https://github.com/SparkPanel/panel/issues/2425
