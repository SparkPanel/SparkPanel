...
export class DdosProtection {
  ...
  private l4Connections: Map<string, Set<string>> = new Map();
  
  
  private l4NewConnections: Map<string, { count: number; resetTime: number }> = new Map();
  ...
  private challengeTokens: Map<string, { token: string; expires: number; solved: boolean }> = new Map();
