...
namespace SparkPanel\Tests\Integration\Services\Databases;
...
class DeployServerDatabaseServiceTest extends IntegrationTestCase
{
    ...
    {
        config()->set('SparkPanel.client_features.databases.allow_random', true);
    ...
    public function testErrorIsThrownIfNoDatabaseHostsExistOnNode()
    {
        ...
        config()->set('SparkPanel.client_features.databases.allow_random', false);
