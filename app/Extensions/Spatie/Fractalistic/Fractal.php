...
namespace SparkPanel\Extensions\Spatie\Fractalistic;
...
use SparkPanel\Extensions\League\Fractal\Serializers\SparkPanelSerializer;
...
class Fractal extends SpatieFractal
{
    ...
    public function createData(): Scope
    {
        ...
        if (is_null($this->serializer)) {
            $this->serializer = new SparkPanelSerializer();
        }
