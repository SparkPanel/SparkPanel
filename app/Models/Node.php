 ...
 * @property \SparkPanel\Models\Mount[]|\Illuminate\Database\Eloquent\Collection $mounts
 * @property \SparkPanel\Models\Server[]|\Illuminate\Database\Eloquent\Collection $servers
 * @property \SparkPanel\Models\Allocation[]|\Illuminate\Database\Eloquent\Collection $allocations
 */
class Node extends Model
{
    ...
    protected $attributes = [
        ...
        'disk_overallocate' => 0,
        'daemonBase' => '/var/lib/SparkPanel/volumes',
        'daemonSFTP' => 2022,
        'daemonListen' => 8080,
