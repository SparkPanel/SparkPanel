...
namespace SparkPanel\Tests\Traits\Integration;
...
trait CreatesTestModels
{
     ...
     *
     * @return array{\SparkPanel\Models\User, \SparkPanel\Models\Server}
     */
    ...
    {
        /** @var Egg $egg */
        $egg = Egg::query()->where('author', 'support@SparkPanel.io')->where('name', 'Bungeecord')->firstOrFail();
