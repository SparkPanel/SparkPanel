...
use SparkPanel\Exceptions\Repository\DuplicateDatabaseNameException;
use SparkPanel\Exceptions\Service\Database\TooManyDatabasesException;
use SparkPanel\Exceptions\Service\Database\DatabaseClientFeatureNotEnabledException;
...
class DatabaseManagementService
{
     ...
     *
     * @see \SparkPanel\Services\Databases\DatabaseManagementService::generateUniqueDatabaseName()
     */
    ...
    {
        if (!config('SparkPanel.client_features.databases.enabled')) {
