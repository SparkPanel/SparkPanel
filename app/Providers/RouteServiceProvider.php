...
use SparkPanel\Http\Middleware\AdminAuthenticate;
...
class RouteServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        // Add explicit binding for server model to handle both ID and UUID
        Route::bind('server', function ($value) {
            return Server::where('id', $value)->first() ?? Server::where('uuid', $value)->first();
        });
